  ...
  const laptops = await Promise.all([
    prisma.product.upsert({
      ...
      create: {
        ...
        description:
          'Powerful all-rounder with AMD Ryzen 7 processor, 16GB RAM, and a large FHD display perfect for development and light gaming.',
        price: 72990,
        originalPrice: 82990,
        rating: 4.3,
        reviewCount: 412,
    ...
    prisma.product.upsert({
      ...
      create: {
        ...
        description:
          'Reliable workhorse laptop with AMD Ryzen 5, 16GB RAM. Great for development tasks and everyday use.',
        price: 67490,
        originalPrice: 74990,
        rating: 4.1,
        reviewCount: 289,
    ...
    prisma.product.upsert({
      ...
      create: {
        ...
        description:
          'Ultra-slim design with Intel Core i5, 16GB RAM. Excellent battery life makes it ideal for Flutter developers on the go.',
        price: 75990,
        originalPrice: 84990,
        rating: 4.4,
        reviewCount: 521,
    ...
    prisma.product.upsert({
      ...
      create: {
        ...
        description:
          'Industry-leading M2 chip, fanless design, exceptional battery life. Best-in-class for iOS/Flutter development.',
        price: 114900,
