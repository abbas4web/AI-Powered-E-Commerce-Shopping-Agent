...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'I need a laptop under ₹80,000 for Flutter development' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Continue an existing conversation' }),
