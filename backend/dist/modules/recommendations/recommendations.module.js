...
const ranking_engine_service_1 = require("./ranking-engine.service");
...
exports.RecommendationsModule = RecommendationsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [recommendations_service_1.RecommendationsService, ranking_engine_service_1.RankingEngineService],
        exports: [recommendations_service_1.RecommendationsService, ranking_engine_service_1.RankingEngineService],
    })
